...
.my-bg-img{
	background: linear-gradient(rgba(0, 0, 0, .4), rgba(0, 0, 0, .4)),url("img/h1.avif");
	height: 20vh;
	width: 100%;
	...
	<div class="container p-3">
		...
		<div class="row">
			...
			<div class="col-md-6 p-5">
				...
				<!-- <img alt="" src="img/doct1.jpg" width="500px" height="400px"> -->
				<img alt="" src="img/d1.jpg" width="370" height="">
			</div>
					...
					<div class="card-body">
						...
						<form class="row g-3" action="addAppointment" method="post">
							...
							<div class="col-md-6">
								...
								required="required"	name="appoint_Date" type="date" class="form-control">
							</div>
							...
							<div class="col-md-6">
								<label class="form-label">Phone</label> <input name="phno"
