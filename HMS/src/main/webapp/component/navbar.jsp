...
<nav class="navbar navbar-expand-lg navbar-dark"style="background-color: #206d84;">
	<div class="container-fluid">
		<a class="navbar-brand" href="index.jsp"><i class="fa-solid fa-stethoscope"></i>  HealthStreet</a>
